...
preset_batch = partial(uncertainty_sampling, n_instances=BATCH_SIZE, proba=False)
...
for i in range(1, 6):
    ...
    mnist_ranked_batch_exp = exp.Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='least_confident_i500_b20_' + str(i)
    )
    ...
    mnist_ranked_batch_exp.save_state('statistic/least_confident_i500_b20_' + str(i))
