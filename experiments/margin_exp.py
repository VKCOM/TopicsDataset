...
preset_batch = partial(margin_sampling, n_instances=BATCH_SIZE, proba=False)
...
for i in range(1, 6):
    ...
    mnist_ranked_batch_exp.save_state('statistic/margin_i500_b20_' + str(i))
