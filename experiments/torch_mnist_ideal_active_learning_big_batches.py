...
for i in range(1, 2):
    ...
    pickle.dump(
        ...
        open('statistic/topics/torch_bn/ideal_active_learning/big_batches.pickle', 'wb')
    )

    print('result:', pickle.load(open('statistic/topics/torch_bn/ideal_active_learning/big_batches.pickle', 'rb')))
