...
from experiments.models.learning_loss_models import LearningLossModel2
...
for i in range(1, 2):
    for n_hidden in range(1, 2):
        ...
        ll_model = LearningLossModel2(n_hidden=n_hidden, metrics=[margin_metric], d=4, use_raw=False)
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_ll2.0_margin_only_n_hidden' + str(n_hidden) + '_i2000_b20_q200_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch_bn/ll2.0_margin_only_n_hidden' + str(n_hidden) + 'inter_i2000_b20_q100_corr' + str(i),
        ...
        experiment.run()
        experiment.save_state('statistic/topics/torch_bn/ll2.0_margin_only_n_hidden' + str(n_hidden) + '_i2000_b20_q200_corr' + str(i))
        pickle.dump(ll_decorated.correllation_history, open('statistic/topics/torch_bn/ll2.0_n_hidden' + str(n_hidden) + '_correlation_history.pkl', 'wb'))
