...
preset_ll = update_wrapper(partial(learning_loss_ideal, n_instances=BATCH_SIZE), learning_loss_ideal)
...
for i in range(3, 4):
    ...
    experiment = Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='torch_topics_ll_ideal_i2000_b20_q200_' + str(i),
        intermediate_state_saving=True,
        intermediate_state_filename='statistic/topics/torch_bn/ll_ideal_inter_i2000_b20_q200_' + str(i),
    ...
    experiment.run()
    experiment.save_state('statistic/topics/torch_bn/ll_ideal_i2000_b20_q200_' + str(i))
