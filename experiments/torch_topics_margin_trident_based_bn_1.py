...
from experiments.models.torch_topics_decorator import TridentAsNormDecorator
...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_d128_' + query_name + '_e1_i2000_b20_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch/endless_queries_bn/' + query_name + '_e1_i2000_b20_inter_' + str(i),
        ...
        experiment.save_state(
            'statistic/topics/torch/endless_queries_bn/' + query_name + '_e1_i2000_b20_' + str(i))
