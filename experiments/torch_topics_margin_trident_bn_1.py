...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            intermediate_state_filename='statistic/topics/torch_bn/' + query_name + '_e1_i2000_b20_q200_inter_' + str(i),
        ...
        experiment.save_state(
            'statistic/topics/torch_bn/' + query_name + '_e1_i2000_b20_q200' + str(i))
