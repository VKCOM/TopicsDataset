...
for i in range(1, 2):
    ...
    x_pool = [np.delete(x_img_train, init_training_indices, axis=0),
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_init_bn_' + query_name + '_e1_i2000_b20_q200_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch_init_bn/' + query_name + '_e1_i2000_b20_q200_inter_' + str(i),
        ...
        experiment.save_state(
            'statistic/topics/torch_init_bn/' + query_name + '_e1_i2000_b20_q200_' + str(i))
