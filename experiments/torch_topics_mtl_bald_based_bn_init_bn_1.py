...
from modAL.qbc_dropout import bald_trident_sampling, bald_trident_based_sampling, bald_trident_bn, bald_trident_based_bn
...
preset_bald_trident_x3 = update_wrapper(partial(bald_trident_based_bn, n_instances=BATCH_SIZE, cmt_size=CMT_SIZE), bald_trident_based_bn)

query_dict = {
    'bald_trident_single_bn': preset_bald_trident_x3
}
