...
preset_bald_trident_x3 = update_wrapper(partial(bald_trident_sampling, n_instances=BATCH_SIZE, cmt_size=CMT_SIZE), bald_trident_sampling)
...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            intermediate_state_filename='statistic/topics/torch_mtl_init_bn/' + query_name + '_i2000_b20_q200_inter_test_' + str(i),
        ...
        experiment.run()
        experiment.save_state('statistic/topics/torch_mtl_init_bn/' + query_name + '_i2000_b20_q200_test_' + str(i))
