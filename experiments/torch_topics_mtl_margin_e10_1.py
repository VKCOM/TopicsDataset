...
from experiments.models.torch_topics_decorator import TridentAsNormDecorator, TridentDecorator, \
    TridentMTLAsNormDecorator

from modAL import KerasActiveLearner
from modAL.uncertainty import margin_trident_sampling, margin_sampling
...
for i in range(1, 2):
    ...
    decorated_model = TridentMTLAsNormDecorator(model, optimizer)
    decorated_model.fit(
        X=x_init_train,
        y=y_init_train,
        epochs=INIT_EPOCHS,
    ...
    for query_name in query_dict:
        ...
        experiment.save_state(
            'statistic/topics/torch/torch_mtl_init_bn/' + query_name + '_e10_i2000_b20_q400_' + str(i))
