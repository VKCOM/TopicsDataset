...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_mtl_init_bn_' + query_name + '_e10_i2000_b20_q400_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch_mtl_init_bn/' + query_name + '_e10_i2000_b20_q400_inter_' + str(i),
        ...
        experiment.save_state(
            'statistic/topics/torch_mtl_init_bn/' + query_name + '_e10_i2000_b20_q400_' + str(i))
