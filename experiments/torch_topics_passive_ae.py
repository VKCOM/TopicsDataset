...
for i in range(1, 6):
    ...
    experiment = Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='torch_topics_ae_passive_es01_tol1_i2000_b20_q200_' + str(i),
        intermediate_state_saving=True,
        intermediate_state_filename='statistic/topics/torch_ae/passive_ae_es01_tol1_i2000_b20_q100_sf512_' + str(i),
    ...
    experiment.run()
    experiment.save_state('statistic/topics/torch_ae/passive_ae_es01_tol1_i2000_b20_q200_' + str(i))
