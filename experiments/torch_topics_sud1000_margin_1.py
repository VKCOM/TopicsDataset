...
for i in range(1, 2):
    for sud_param in sud_params:
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_sud_faiss_top' + str(sud_param) + '_trivial_encode_ad64_margin_i2000_b20_q100_' + str(i)
        )

        experiment.run()
        experiment.save_state(
            'statistic/topics/torch/d128/sud_faiss_top' + str(sud_param) + '_trivial_encode_ad64_margin_i2000_b20_q100_' + str(i))
