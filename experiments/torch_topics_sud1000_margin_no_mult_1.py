...
for i in range(1, 2):
    ...
    experiment = Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='torch_topics_sud1000_trivial_encode_ad64_margin_no_mult_i2000_b20_q100_sf512_' + str(i),
        autoencoder=autoencoder,
        autoencoder_optim=autoencoder_optimizer
    )

    experiment.run()
    experiment.save_state('statistic/topics/torch/d128/sud1000_trivial_encode_ad64_margin_no_mult_i2000_b20_q100_sf512_' + str(i))
