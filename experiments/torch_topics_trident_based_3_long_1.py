...
preset_bald_trident_based_3 = update_wrapper(partial(bald_trident_based_sampling, n_instances=BATCH_SIZE, cmt_size=CMT_SIZE), bald_trident_sampling)

query_dict = {
    'bald_trident_based_3': preset_bald_trident_based_3
}
