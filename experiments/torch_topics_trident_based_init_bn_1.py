...
preset_bald_trident_x3 = update_wrapper(partial(bald_trident_based_sampling, n_instances=BATCH_SIZE, cmt_size=CMT_SIZE), bald_trident_based_sampling)

query_dict = {
    'bald_x3': preset_bald_trident_x3
}
...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_endless_init_bn_' + query_name + '_e1_i2000_b20_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch_init_bn/' + query_name + '_i2000_b20_q200_inter_' + str(i),
        ...
        experiment.run()
        experiment.save_state('statistic/topics/torch_init_bn/' + query_name + '_i2000_b20_q200_' + str(i))
