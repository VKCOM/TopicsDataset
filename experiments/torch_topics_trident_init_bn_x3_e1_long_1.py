...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            intermediate_state_filename='statistic/topics/torch/endless_queries_init_bn/' + query_name + '_e1_i2000_b20_inter_' + str(i),
        ...
        experiment.run()
        experiment.save_state('statistic/topics/torch/endless_queries_init_bn/' + query_name + '_e1_i2000_b20_' + str(i))
