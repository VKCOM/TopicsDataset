...
for i in range(1, 2):
    ...
    for query_name in query_dict:
        ...
        experiment = Experiment(
            ...
            random_seed=i,
            pool_size=POOL_SIZE,
            name='torch_topics_endless_' + query_name + '_es_i2000_b20_' + str(i),
            intermediate_state_saving=True,
            intermediate_state_filename='statistic/topics/torch/endless_queries/' + query_name + '_es_i2000_b20_' + str(i),
        ...
        experiment.run()
        experiment.save_state('statistic/topics/torch/endless_queries/' + query_name + '_es_i2000_b20_' + str(i))
