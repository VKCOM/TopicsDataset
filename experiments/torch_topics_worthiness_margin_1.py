...
from modAL.uncertainty import margin_multitask_sampling
...
preset_query = update_wrapper(partial(margin_multitask_sampling, n_instances=BATCH_SIZE), margin_multitask_sampling)
...
for i in range(1, 2):
    ...
    experiment = Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='topic_worthiness_margin_i2000_b20_q200_weight300_' + str(i),
        epochs=1,
        weight=WEIGHT,
    ...
    experiment.run()
    experiment.save_state('statistic/topic_worthiness/margin_i2000_b20_q200_weight300_' + str(i))
