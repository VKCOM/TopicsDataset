...
from experiments.models.torch_worthiness_decorator import WorthinessDecorator
from experiments.models.worthiness_models import WorthinessNormModelBN
...
for i in range(1, 2):
    ...
    experiment = Experiment(
        ...
        random_seed=i,
        pool_size=POOL_SIZE,
        name='worthiness_passive_i2000_b20_q200_weight300_' + str(i),
        epochs=1,
        weight=WEIGHT
    )

    experiment.run()
    experiment.save_state('statistic/worthiness/norm/passive_i2000_b20_q200_weight300_' + str(i))
